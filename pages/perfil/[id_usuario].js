...
export default function Usuarios({ usuarios, roles, carrera, nombres }) {
    ...
    return (
        <div >
            ...
            <div>
                <div className="row p-5 d-flex justify-content-md-center align-items-center m-0" style={{height: "100%"}}>
                    <div className="col-md-3 border-right mycontent-left">

                        <div className="d-flex flex-column align-items-center text-center p-3 py-5">
                            <img src={"/sample-avatar.jpg"} width="100" height="100"></img>
                            <span className="font-weight-bold text-white p-1">{usuarios[0].nombre}</span><span class="text-white-50">{usuarios[0].nombre + "@gmail.com"}</span><span> </span></div>
                    </div>
